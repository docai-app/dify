...
const ConfigModal: FC<IConfigModalProps> = ({
    ...
    const handleConfirm = () => {
        ...
        if (isStringInput || type === InputVarType.number || type === InputVarType.file) {
                ...
                <div className='space-y-2'>
                    ...
                    <Field title={t('appDebug.variableConig.fieldType')}>
                        <div className='flex space-x-2'>
                            ...
                            <SelectTypeItem type={InputVarType.file} selected={type === InputVarType.file} onClick={() => handlePayloadChange('type')(InputVarType.file)} />
                        </div>
                    </Field>
