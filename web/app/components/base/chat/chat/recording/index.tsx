...
const RecordingView: FC<ChatProps> = ({
    ...
    const text_to_audio = async (text: string, index: number) => {
        const speechKey = process.env.NEXT_PUBLIC_AZURE_SPEECH_KEY || "5c6abcbff83643d1900b89bb8ec14243";
        ...
        const ssml = `<speak version='1.0' xml:lang='en-US'>
            <voice xml:lang='en-US' xml:gender='Female' name='zh-HK-HiuMaanNeural'>
                ${text}
            </voice>
        </speak>`;

        // console.log('fetch url', ttsUrl);
                                    ...
                                    <div className={` w-full flex justify-center  absolute -bottom-12 `}>
                                        ...
                                        <div className="w-full">
                                            <ChatInput
                                                ...
                                                onSend={(message: string) => { sendPreMessage(message) }}
