        ...
        <>
            ...
            <div className='mb-8'>
                ...
                {session ?
                    ...
                    :
                    <>
                        <div className='mb-2 text-xs text-gray-500'>{t('common.account.bindGoogleDriveAccount')}</div>
                        <Button className='font-medium text-white !px-3 !py-[7px] !text-[13px] bg-red-500 hover:bg-red-700'
                            onClick={() => {
                                signIn('google', { params: { access_type: 'offline' } });
                            }}>{t('common.account.bind')}</Button>
                    </>
                }
            </div>
