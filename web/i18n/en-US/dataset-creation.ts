const translation = {
    ...
    stepOne: {
        ...
        dataSourceType: {
            ...
            drive: 'Sync from Notion Google Drive',
        ...
        driveSyncTitle: 'Google Drive is not connected',
        driveSyncTip: 'To sync with Google Drive, connection to Google Drive must be established first.',
