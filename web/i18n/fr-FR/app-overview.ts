const translation = {
    ...
    apiKeyInfo: {
        ...
        tryCloud: 'Ou essayez la version cloud de DocAI avec un devis gratuit',
    },
    overview: {
        title: 'Aperçu',
        appInfo: {
            ...
            settings: {
                ...
                more: {
                    ...
                    privacyPolicyTip: 'Aide les visiteurs à comprendre les données collectées par l\'application, voir la <privacyPolicyLink>Politique de confidentialité</privacyPolicyLink> de DocAI.',
                },
            },
            embedded: {
                entry: 'Intégré',
                ...
                chromePlugin: 'Installer l\'extension Chrome DocAI Chatbot',
                copied: 'Copié',
                copy: 'Copier',
            },
            qrcode: {
            ...
            customize: {
                ...
                way1: {
                    ...
                    step1Operation: 'Client-Web-DocAI',
