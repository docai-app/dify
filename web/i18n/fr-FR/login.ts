const translation = {
    ...
    welcome: 'Bienvenue sur DocAI, veuillez vous connecter pour continuer.',
    ...
    license: {
        tip: 'Avant de commencer DocAI Community Edition, lisez le GitHub',
        link: 'Licence Open-source',
    },
    join: 'Rejoindre',
    joinTipStart: 'Je vous invite à rejoindre',
    joinTipEnd: 'équipe sur DocAI',
    invalid: 'Le lien a expiré',
    explore: 'Explorez DocAI',
